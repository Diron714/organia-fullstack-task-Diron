...
class JwtServiceTest {
  ...
  void generate_validate_expiry() {
    JwtService service = new JwtService(new com.organia.taskmanager.security.JwtService(new JwtConfig("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!@", 1000, 2000)));
